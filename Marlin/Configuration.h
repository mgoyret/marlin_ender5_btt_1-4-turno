...
#define STRING_CONFIG_H_AUTHOR "marcosgoyret@gmail.com" // Who made the changes.
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 800, 93 } // marlin examples for ender-5
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 500, 500, 5, 25 } // marlin examples for ender-5
...
//#define CLASSIC_JERK
  ...
  #endif
#endif
#define DEFAULT_EJERK    5.0  // May be used by Linear Advance //  // marlin examples for ender-5
/**
 ...
 */
//#define S_CURVE_ACCELERATION opcional
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET_X 50 // X is the biggest offset, so BED_TRAMMING_INSET_LFRB must all have this value for simetry
#define NOZZLE_TO_PROBE_OFFSET { NOZZLE_TO_PROBE_OFFSET_X, 20, 0 } // measured by me
...
#define INVERT_X_DIR false // marlin examples for ender-5
#define INVERT_Y_DIR false // marlin examples for ender-5
#define INVERT_Z_DIR true // marlin examples for ender-5
...
#define X_MIN_POS -1 // tiny value in case i need offset adjusting.
#define Y_MIN_POS -1 // tiny value in case i need offset adjusting.
#define Z_MIN_POS -3 // tiny value in case i need offset adjusting.
...
#define LCD_BED_TRAMMING
  ...
  #define BED_TRAMMING_INSET_LFRB { NOZZLE_TO_PROBE_OFFSET_X, NOZZLE_TO_PROBE_OFFSET_X, NOZZLE_TO_PROBE_OFFSET_X, NOZZLE_TO_PROBE_OFFSET_X } // (mm) Left, Front, Right, Back insets
