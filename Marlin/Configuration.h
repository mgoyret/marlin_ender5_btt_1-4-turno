 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 40, -5, 0 } // measured by me
...
#define INVERT_X_DIR true // marlin examples for ender-5
#define INVERT_Y_DIR true // marlin examples for ender-5
