...
//#define E3D_Extreme     // Enable to print at over 285°C. Strongly discouraged by E3D
...
#define STRING_CONFIG_H_AUTHOR "(electroman, Ender-5)" // Who made the changes.
...
#define MACHINE_UUID "00000000-0000-0000-0000-000000001999"
 ...
 * Override with M92
 * How many stepps the stepper needs, in order to ahive a 1mm linear movement of the respective axis (X,Y,Z,Extruder)
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
...
#define X_MIN_POS -2 // tiny value in case i need offset adjusting.
#define Y_MIN_POS -2
#define Z_MIN_POS -3
